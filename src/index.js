    ...
    return (
      <div key='attr' className='pigeon-attribution' style={style}>
        {attributionPrefix === false ? null : (
          <span>
            {attributionPrefix || <a href='https://pigeon-maps.js.org/' target='_blank' rel='noopener' style={linkStyle}>Pigeon</a>}
            {' | '}
          </span>
        )}
        {attribution || (<span>
          {' © '}
          <a href='https://www.openstreetmap.org/copyright' target='_blank' rel='noopener' style={linkStyle}>OpenStreetMap</a>
          {' contributors'}
        </span>)}
      </div>
    )
