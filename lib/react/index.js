...
var React = false ? require('inferno') : require('react');
var Component = false ? require('inferno-component') : React.Component;
...
var Map = function (_Component) {
  ...
  function Map(props) {
    ...
    _this.setCenterZoomTarget = function (center, zoom, fromProps) {
      ...
      if (_this.props.animate) {
        if (_this._isAnimating) {
          ...
          _this._centerStart = _this.limitCenterAtZoom([_this.state.center[0], _this.state.center[1]], _this.state.zoom);
    ...
    _this.setCenterZoom = function (center, zoom) {
      ...
      _this.setState({ center: limitedCenter, zoom: zoom });
      ...
      if (Math.abs(maybeZoom - zoom) > 0.001 || Math.abs(maybeCenter[0] - limitedCenter[0]) > 0.0001 || Math.abs(maybeCenter[1] - limitedCenter[1]) > 0.0001) {
    ...
    _this.calculateZoomCenter = function (center, coords, oldZoom, newZoom) {
      ...
      return _this.limitCenterAtZoom([center[0] - diffLat, center[1] - diffLng], newZoom);
    };
  ...
  _createClass(Map, [{
      ...
      return React.createElement(
        ...
        React.createElement(
          ...
          tiles.map(function (tile) {
            return React.createElement('img', { key: tile.key,
              src: tile.url,
              width: tile.width,
              height: tile.height,
    ...
    value: function renderAttribution() {
      ...
      return React.createElement(
        'div',
        { key: 'attr', className: 'pigeon-attribution', style: {
            position: 'absolute',
            bottom: 0,
            right: 0,
            fontSize: '11px',
        ...
        attributionPrefix === false ? null : React.createElement(
          'span',
          null,
          attributionPrefix || React.createElement(
            'a',
        ...
        attribution || React.createElement(
          'span',
          null,
          ' © ',
          React.createElement(
