...
var Map = function (_Component) {
  ...
  _createClass(Map, [{
    ...
    value: function render() {
      ...
      var tileElements = _react2.default.createElement(
        'div',
        { style: boxStyle },
        _react2.default.createElement(
          ...
          tiles.map(function (tile) {
            return _react2.default.createElement('img', { key: tile.key, src: tile.url, width: tile.width, height: tile.height, style: { position: 'absolute', left: tile.left, top: tile.top, transform: tile.transform, transformOrigin: 'top left' } });
          })
        )
      );
      ...
      var childrenWithProps = _react2.default.Children.map(this.props.children, function (child) {
        ...
        if (position) {
          var c = _this2.latLngToPixel(position[0], position[1], zoom);
      ...
      var overlayElements = _react2.default.createElement(
        'div',
        { style: childrenStyle },
        childrenWithProps
      );
